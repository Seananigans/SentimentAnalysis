...
waterworld_url = "http://www.imdb.com/title/tt0114898/reviews?start={}"
epic_movie_url = "http://www.imdb.com/title/tt0799949/reviews?start={}"
star_wars_ep1_url = "http://www.imdb.com/title/tt0120915/reviews?start={}"
...
def main():
	for i in range(0,3600, 10):
		try:
			source_code = opener.open( star_wars_ep1_url.format(i)).read()
