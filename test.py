...
loadWordArrays()
weights=[-7.5, 0.2]
print testSentiment('positiveSentiment.txt', weights)
print testSentiment("negativeSentiment.txt", weights)
...
x0 = np.array([-7.5, 0.2])
res = spo.minimize(sum_accuracies, x0, method='nelder-mead')
print res.x